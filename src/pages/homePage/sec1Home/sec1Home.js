      ...
      <body className="container2">
        <div className='charity'>
            <div className='featured'>
                ...
                <p className='difference-text'>Let Us Come Together <br/> To Make a Difference</p>
                <p className='description'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo.</p>
                <div className='side'>
                    <div className='boxes'>
        ...
        <div className='latest-causes'>
            ...
            <p className='difference-text'> Find the popular cause <br/> and donate them</p>
            <div style={{display:'flex', flexWrap:'wrap'}}>
                <Card style={{ width: '288px' ,background:'#E5E5E5', marginTop:35,marginRight:50}}>
                    ...
                    <Card.Body style={{margin:'10px'}}>
                        <Card.Title style={{color:'#219D80', fontWeight:600,fontSize:'16px',marginTop:'10px',marginBottom:'10px'}}>Card Title</Card.Title>
                        <Card.Text>
