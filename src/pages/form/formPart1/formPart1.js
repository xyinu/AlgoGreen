    ...
    return (
      <body className="part-1">
        ...
        <div className='form-input'>
            ...
            <p style={{opacity:0.9,marginBottom:14}}>This will be your DAO’s unique ENS subdomain, created automatically for you.</p>
            <input className='input'  placeholder='AlgoGreen'/>
        </div>
        <div className='form-input'>
            <p style={{fontWeight:600,fontSize:20,marginBottom:10}}>Description</p>
            <p style={{opacity:0.9,marginBottom:10,width:'65%'}}>Describe your DAO's purpose in a few sentences. This is listed on the Explore page so new contributors can find you.</p>
            <textarea className='input-big'  placeholder='Type your Summary...'/>
        </div>
        <div className='form-input'>
            <p style={{fontWeight:600,fontSize:20,marginBottom:10}}>Links</p>
            <p style={{opacity:0.9,marginBottom:10}}>Links to your DAO's website, social media profiles, Discord, or other places your community gathers.</p>
            {inputs.map((item)=>item)}
        </div>
            <button onClick={handleAddInput} className='butin'> Add Link </button>
            <button onClick={handleNext} className='butnext'>Next</button>
      </body>
    );
  };
